...
describe('UI Store', () => {
  ...
  describe('Notifications', () => {
    ...
    it('should add notification with custom duration', () => {
      const id = uiActions.addNotification('info', 'Test', undefined, 3000);

      expect(uiState.notifications[0].duration).toBe(3000);
    });

    it('should set error notifications to persist by default', () => {
      const id = uiActions.addNotification('error', 'Error Message');
    ...
    it('should auto-dismiss notifications with duration', () => {
      const id = uiActions.addNotification('success', 'Auto Dismiss', undefined, 1000);
    ...
    it('should not auto-dismiss notifications with duration 0', () => {
      const id = uiActions.addNotification('error', 'Persist', undefined, 0);
    ...
    it('should add notification with action', () => {
      ...
      const id = uiActions.addNotification(
        'info',
        'Test',
        'Message',
        5000,
