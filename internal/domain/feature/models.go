...
// EvaluationRequest represents a request to evaluate a feature flag
type EvaluationRequest struct {
	FlagKey string            `json:"flag_key"`
	Context EvaluationContext `json:"context"`
}

// Evaluation represents the evaluation result
...
// BatchEvaluationRequest represents a request to evaluate multiple flags
...
// Context is an alias for EvaluationContext for interface compatibility
type Context = EvaluationContext

// Flag is an alias for FeatureFlag for interface compatibility
type Flag = FeatureFlag

// FlagState represents the state of all flags for a context
...
// Analytics represents analytics data for a flag
type Analytics struct {
	FlagID    uuid.UUID              `json:"flag_id"`
	FlagKey   string                 `json:"flag_key"`
	Period    string                 `json:"period"`
	Stats     FlagStats              `json:"stats"`
